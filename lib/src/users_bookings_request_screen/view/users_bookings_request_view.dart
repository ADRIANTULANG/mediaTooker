                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [
                              CachedNetworkImage(
                                imageUrl: controller.usertype.value == "Client"
                                    ? controller
                                        .bookingsList[index].providerProfilePic
                                    : controller
                                        .bookingsList[index].clientProfilePic,
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Text(
                                      controller.usertype.value == "Client"
                                          ? controller
                                              .bookingsList[index].providerName
                                          : controller
                                              .bookingsList[index].clientName,
                                      style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                controller.bookingsList[index].projectTitle,
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: AppFontSizes.regular),
                              ),
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 5.w, right: 5.w),
                          child: Text(
                            controller.bookingsList[index].message,
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                fontSize: AppFontSizes.regular),
                          ),
