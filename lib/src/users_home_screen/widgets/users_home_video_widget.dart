...
class UsersHomeVideoWidget extends StatefulWidget {
  const UsersHomeVideoWidget(
      {super.key, required this.url, required this.index});
  final String url;
  final int index;

  @override
  State<UsersHomeVideoWidget> createState() => _UsersHomeVideoWidgetState();
}

class _UsersHomeVideoWidgetState extends State<UsersHomeVideoWidget> {
